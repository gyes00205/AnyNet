...
parser.add_argument('--KITTI', default='2015',
                    help='KITTI version')
parser.add_argument('--datapath', default='/media/bsplab/Transcend/data_scene_flow_2015/testing/',
                    help='select model')
parser.add_argument('--loadmodel', default='./trained_2015/trained_2015finetune_243.tar',
                    help='loading model')
parser.add_argument('--model', default='AnyNet',
                    help='select model')
...
parser.add_argument('--savedir', default='output',
                    help='output path to save image')                
...
def main():
    ...
    for inx in index_pbar:
        ...
        img.save(os.path.join(args.savedir, test_left_img[inx].split('/')[-1]))
